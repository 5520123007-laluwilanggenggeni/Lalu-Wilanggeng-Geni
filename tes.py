...
def main():
    ...
    button_hapus_nilai = tk.Button(window, text="Hapus Nilai Mahasiswa", command=hapus_nilai)
    button_hapus_nilai.pack()

    button_ubah_nilai = tk.Button(window, text="Ubah Nilai Mahasiswa", command=ubah_nilai)
    button_ubah_nilai.pack()

    button_hitung_nilai_akhir = tk.Button(window, text="Hitung Nilai Akhir Mahasiswa", command=hitung_nilai_akhir)
